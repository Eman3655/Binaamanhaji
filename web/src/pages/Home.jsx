...
const copy = {
  hero: {
    titleTop: "مكتبة العطاء",
    titleAccent: "البناء المنهجي — الدفعة الثالثة",
...
function HeroLanding() {
  return (
    ...
    منصة تجمع ملفات الدروس والمقررات الخاصة بالدفعة الثالثة من البناء المنهجي ، نوفّر بحثًا سريعًا حسب المستوى والعِلم والمقرّر — لتصل إلى النسخة الصحيحة في ثوانٍ.
          </p>
